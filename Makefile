...
test-pure:
	$(PYTHON) -m pytest tests/test_smoke.py tests/test_hardening_v2.py tests/test_distribution_smoke.py tests/test_distribution_v0_2_smoke.py -v --tb=short -m "not services_required"
...
distribute-test:
	$(PYTHON) -m pytest tests/test_distribution_smoke.py tests/test_distribution_v0_2_smoke.py -v --tb=short -m "not services_required"
